...
{
    /// <summary>
    /// Modified verion of VRM10ExportDialog
    /// </summary>
    public class ModifiedExportDialog : ExportDialogBase
    {
        public const string MENU_NAME = "Export VRM 1.0 with Material Extensions";

        public static void Open()
        {
            var window = GetWindow<ModifiedExportDialog>(MENU_NAME);
            window.Show();
        }
        ...
        {
            Debug.Log($"<color=cyan>[ModifiedExportDialog] Export VRM 1.0 with Material Extensions.</color>");
            ...
            try
            {
                ...
                using (var arrayManager = new NativeArrayManager())
                {
                    ...
                    var exporter = new Vrm10Exporter(
                        ...
                        materialExporter: new lilToonVrm10MaterialExporter(), // Modified
